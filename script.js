...
class Products {
    async getProducts() {
        try {
            let result = await fetch("https://66aa9a47636a4840d7c8220f.mockapi.io/products");
...
class UI {
    ...
    saveCartValues(cart) {
        ...
        cardItems.innerText = itemsTotal;
    }
...
class Storage {
    static saveProducts(products) {
        localStorage.setItem("samet", JSON.stringify(products));
    }

    static getProduct(id) {
        let products = JSON.parse(localStorage.getItem("samet"));
